...
rsvg-convert -w 808 -h 608 splash.svg > src/main/resources/de/thomas_oster/visicut/gui/resources/splash@2x.png
rsvg-convert -w 1212 -h 912 splash.svg > src/main/resources/de/thomas_oster/visicut/gui/resources/splash@3x.png
echo "cleaning..."
rm splash.svg
echo "done."
