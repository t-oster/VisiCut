...
public class EditProfilesDialog extends javax.swing.JDialog implements EditableTableProvider
{
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/EditProfilesDialog"); // NOI18N
        setTitle(bundle.getString("TITLE")); // NOI18N
        setName("Form"); // NOI18N

        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(de.thomas_oster.visicut.gui.VisicutApp.class).getContext().getResourceMap(EditProfilesDialog.class);
...
private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
  ...
  this.setVisible(false);
    ...
    public Object getNewInstance() {
      ...
      choose.addItem(java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/EditProfilesDialog").getString("LINE PROFILE"));
      choose.addItem(java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/EditProfilesDialog").getString("RASTER PROFILE"));
      choose.addItem(java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/EditProfilesDialog").getString("RASTER3D PROFILE"));
      if (JOptionPane.showConfirmDialog(this, choose, java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/EditProfilesDialog").getString("WHICH KIND OF PROFILE?"), JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
          if (choose.getSelectedItem().equals(java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/EditProfilesDialog").getString("LINE PROFILE"))) {
              return editObject(new VectorProfile());
          } else if (choose.getSelectedItem().equals(java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/EditProfilesDialog").getString("RASTER PROFILE"))) {
              return editObject(new RasterProfile());
          } else if (choose.getSelectedItem().equals(java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/EditProfilesDialog").getString("RASTER3D PROFILE"))) {
