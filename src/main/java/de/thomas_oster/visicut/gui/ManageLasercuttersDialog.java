...
public class ManageLasercuttersDialog extends javax.swing.JDialog implements EditableTableProvider
{
  ...
  private DefaultTableModel model = new DefaultTableModel()
  {
    ...
    {
      java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/ManageLasercuttersDialog").getString("NAME"), java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/ManageLasercuttersDialog").getString("DRIVER")
    };
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/ManageLasercuttersDialog"); // NOI18N
        setTitle(bundle.getString("TITLE")); // NOI18N
        setName("Form"); // NOI18N

        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(de.thomas_oster.visicut.gui.VisicutApp.class).getContext().getResourceMap(ManageLasercuttersDialog.class);
  ...
  public Object getNewInstance()
  {
    ...
    if (JOptionPane.showConfirmDialog(this, driver, java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/ManageLasercuttersDialog").getString("PLEASE SELECT A DRIVER"), JOptionPane.OK_CANCEL_OPTION)==JOptionPane.CANCEL_OPTION)
    {
      return null;
    }
