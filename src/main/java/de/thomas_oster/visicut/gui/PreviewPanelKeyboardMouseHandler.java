...
import de.thomas_oster.visicut.gui.beans.EditRectangle.Button;
import de.thomas_oster.visicut.gui.beans.EditRectangle.ParameterField;
...
public class PreviewPanelKeyboardMouseHandler extends EditRectangleController implements MouseListener, MouseMotionListener, KeyListener
{
  ...
  {
    ResourceBundle bundle = java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/PreviewPanelKeyboardMouseHandler");
    ...
    {//Check if clicked on one of the parameters Button
      try
      {
        if (this.getEditRect().isRotateMode())
        {
          ...
          {
            Double a = dialogHelper.askAngle(java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/PreviewPanelKeyboardMouseHandler").getString("ANGLE"), this.getEditRect().getRotationAngle());
            if (a == null)
            {
              return true;
            }
        ...
        else
        {
          ...
          {
            Double x = dialogHelper.askLength(java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/PreviewPanelKeyboardMouseHandler").getString("LEFT OFFSET"), this.getEditRect().x);
            if (x == null)
            {
              return true;
            }
            ...
            {
              dialogHelper.showErrorMessage(java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/PreviewPanelKeyboardMouseHandler").getString("OUT_OF_BOUNDS"));
              return true;
            }
          ...
          if (this.getEditRect().getParameterFieldBounds(EditRectangle.ParameterField.Y).contains(me.getPoint()))
          {
            ...
            Double y = dialogHelper.askLength(java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/PreviewPanelKeyboardMouseHandler").getString(originBottom ? "BOTTOM OFFSET" : "TOP OFFSET"), originBottom ? bedHeight - this.getEditRect().y - this.getEditRect().height : this.getEditRect().y);
            if (y == null)
            {
              return true;
            }
          ...
          {
            Double w = dialogHelper.askLength(java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/PreviewPanelKeyboardMouseHandler").getString("WIDTH"), this.getEditRect().width);
            if (w == null)
            {
              return true;
            }
          ...
          {
            Double h = dialogHelper.askLength(java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/PreviewPanelKeyboardMouseHandler").getString("HEIGHT"), this.getEditRect().height);
            if (h == null)
            {
              return true;
            }
