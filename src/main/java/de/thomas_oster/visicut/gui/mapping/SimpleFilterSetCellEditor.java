...
class SimpleFilterSetCellEditor extends DefaultCellEditor
{
  ...
  public String EVERYTHING_ELSE = java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/mapping/resources/CustomMappingPanel").getString("EVERYTHING_ELSE");
