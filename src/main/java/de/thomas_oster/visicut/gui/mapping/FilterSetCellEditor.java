...
public class FilterSetCellEditor extends AbstractCellEditor implements TableCellEditor
{
  ...
  { 
    value = (FilterSet) o;
    button.setText(value == null ? java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/mapping/resources/CustomMappingPanel").getString("EVERYTHING_ELSE") : value.toString());
    skipOne = true;
    return button;
  }
