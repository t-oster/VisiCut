...
public class FilterSetCellRenderer extends DefaultTableCellRenderer
{
  ...
  public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column)
  {
    ...
    if (c instanceof JLabel)
    {
      if (value == null)
      {
        String text = java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/mapping/resources/CustomMappingPanel").getString("EVERYTHING_ELSE");
        ((JLabel) c).setText(text);
      }
      if (value instanceof FilterSet)
      {
        String text = java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/mapping/resources/CustomMappingPanel").getString("EVERYTHING");
