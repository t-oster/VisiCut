...
public class EditMaterialsDialog extends javax.swing.JDialog implements EditableTableProvider
{
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/EditMaterialsDialog"); // NOI18N
        setTitle(bundle.getString("TITLE")); // NOI18N
        setName("Form"); // NOI18N

        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(de.thomas_oster.visicut.gui.VisicutApp.class).getContext().getResourceMap(EditMaterialsDialog.class);
