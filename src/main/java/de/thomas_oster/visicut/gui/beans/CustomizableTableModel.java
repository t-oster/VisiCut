...
public class CustomizableTableModel extends DefaultTableModel
{
  ...
  {
    java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/EditLaserDeviceDialog").getString("ATTRIBUTE"), java.util.ResourceBundle.getBundle("de.thomas_oster/visicut/gui/resources/EditLaserDeviceDialog").getString("VALUE")
  };
