...
public class SelectThumbnailButton extends JButton implements ActionListener
{
  ...
  {
    filter = new ExtensionFilter(new String[]{".png",".jpg",".jpeg"}, java.util.ResourceBundle.getBundle("de.thomas_oster/uicomponents/resources/SelectThumbnailButton").getString("ICON FILES (*.PNG,*.JPG)"));
  ...
  public final void setThumbnailPath(String thumbnailPath)
  {
    ...
    else
    {
      ...
      {
        this.setText(java.util.ResourceBundle.getBundle("de.thomas_oster/uicomponents/resources/SelectThumbnailButton").getString("FILE NOT FOUND"));
      }
    }
  }
  ...
  public void actionPerformed(ActionEvent ae)
  {
    if (Helper.isMacOS())
    {
      FileDialog fd = new FileDialog((Frame) null, java.util.ResourceBundle.getBundle("de.thomas_oster/uicomponents/resources/SelectThumbnailButton").getString("PLEASE SELECT A THUMBNAIL"));
