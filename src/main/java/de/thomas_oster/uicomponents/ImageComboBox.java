...
public class ImageComboBox extends JComboBox
{
    ...
    public Component getListCellRendererComponent(JList jlist, Object o, int i, boolean bln, boolean bln1)
    {
      ...
      if (c instanceof JLabel)
      {
        ...
        else
        {
          if (o == null)
          {
            l.setText(java.util.ResourceBundle.getBundle("de.thomas_oster/uicomponents/resources/ImageComboBox").getString("PLEASE SELECT"));
          }
  ...
  {
    this.setDisabled(o, disabled, java.util.ResourceBundle.getBundle("de.thomas_oster/uicomponents/resources/ImageComboBox").getString("DISABLED"));
  }
