...
public class QRWebcamScanDialog extends JDialog implements Observer
{
  ...
  private ResourceBundle bundle = java.util.ResourceBundle.getBundle("com/frochr123/gui/QRWebcamScanDialog");
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(de.thomas_oster.visicut.gui.VisicutApp.class).getContext().getResourceMap(QRWebcamScanDialog.class);
