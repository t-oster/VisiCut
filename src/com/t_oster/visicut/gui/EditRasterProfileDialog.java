...
public class EditRasterProfileDialog extends javax.swing.JDialog
{
  ...
  public void setCurrentRasterProfile(RasterProfile currentRasterProfile)
  {
    ...
    this.thumbnailButton.setText("<html><table cellpadding=3><tr><td><img width=64 height=64 src=file://" + currentRasterProfile.getThumbnailPath() + "/></td></tr></table></html>");
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        thumbnailButton.setText(resourceMap.getString("thumbnailButton.text")); // NOI18N
        thumbnailButton.setName("thumbnailButton"); // NOI18N
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${currentRasterProfile.color}"), jButton2, org.jdesktop.beansbinding.BeanProperty.create("background"));
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${currentRasterProfile.description}"), jTextField2, org.jdesktop.beansbinding.BeanProperty.create("text"), "desc");
        bindingGroup.addBinding(binding);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(thumbnailButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
  ...
  {//GEN-HEADEREND:event_thumbnailButtonActionPerformed

    JFileChooser fc = new JFileChooser();     fc.setAcceptAllFileFilterUsed(false);     fc.addChoosableFileFilter(new ExtensionFilter(".png", "PNG Files (*.png)"));     if (this.currentRasterProfile.getThumbnailPath() != null)     {       fc.setSelectedFile(new File(this.currentRasterProfile.getThumbnailPath()));       fc.setCurrentDirectory(new File(this.currentRasterProfile.getThumbnailPath()).getParentFile());     }     fc.setDialogType(JFileChooser.OPEN_DIALOG);     if (fc.showOpenDialog(this) == JFileChooser.APPROVE_OPTION)     {       File thumb = fc.getSelectedFile();       this.currentRasterProfile.setThumbnailPath(thumb.getAbsolutePath());       this.thumbnailButton.setText("<html><table cellpadding=3><tr><td><img width=64 height=64 src=file://" + thumb.getAbsolutePath() + "/></td></tr></table></html>");     }   }//GEN-LAST:event_thumbnailButtonActionPerformed
  ...
  {//GEN-HEADEREND:event_jButton2ActionPerformed
    ...
    this.currentRasterProfile.setColor(JColorChooser.showDialog(this, "Please select the Material Color", this.currentRasterProfile.getColor()));     this.jButton2.setBackground(this.currentRasterProfile.getColor());   }//GEN-LAST:event_jButton2ActionPerformed
