...
public class EditVectorProfileDialog extends javax.swing.JDialog
{
  ...
  public void setCurrentVectorProfile(VectorProfile currentVectorProfile)
  {
    ...
    this.thumbnailButton.setText("<html><table cellpadding=3><tr><td><img width=64 height=64 src=file://" + currentVectorProfile.getThumbnailPath() + "/></td></tr></table></html>");
  ...
  {//GEN-HEADEREND:event_thumbnailButtonActionPerformed
    ...
    JFileChooser fc = new JFileChooser();     fc.setAcceptAllFileFilterUsed(false);     fc.addChoosableFileFilter(new ExtensionFilter(".png", "PNG Files (*.png)"));     if (this.currentVectorProfile.getThumbnailPath() != null)     {       fc.setSelectedFile(new File(this.currentVectorProfile.getThumbnailPath()));       fc.setCurrentDirectory(new File(this.currentVectorProfile.getThumbnailPath()).getParentFile());     }     fc.setDialogType(JFileChooser.OPEN_DIALOG);     if (fc.showOpenDialog(this) == JFileChooser.APPROVE_OPTION)     {       File thumb = fc.getSelectedFile();       this.currentVectorProfile.setThumbnailPath(thumb.getAbsolutePath());       this.thumbnailButton.setText("<html><table cellpadding=3><tr><td><img width=64 height=64 src=file://" + thumb.getAbsolutePath() + "/></td></tr></table></html>");     }   }//GEN-LAST:event_thumbnailButtonActionPerformed
