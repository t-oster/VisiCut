...
public class MainView extends javax.swing.JFrame
{
  ...
  public MainView()
  {
    ...
    this.customMappingPanel2.getLoadButton().addActionListener(new ActionListener(){
      public void actionPerformed(ActionEvent ae)
      {
        // TODO: similar code is in PredefinedMappingComboBoxChanged()
  ...
  private void fillComboBoxes()
  {
    ...
    // TODO this should be in italics, but (at least with GTK-UI) the html-string does not get grayed out when disabled
    // as a workaround, I did not apply the following line:
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        predefinedMappingRadioButton = new javax.swing.JRadioButton();
        customMappingRadioButton = new javax.swing.JRadioButton();
        predefinedMappingComboBox = new javax.swing.JComboBox();
        ...
        mappingPanel.setName("customMappingPanelContainer"); // NOI18N

        customMappingPanel2.setName("customMappingPanel2"); // NOI18N

        buttonGroup1.add(predefinedMappingRadioButton);
        predefinedMappingRadioButton.setSelected(true);
        predefinedMappingRadioButton.setText(resourceMap.getString("predefinedMappingRadioButton.text")); // NOI18N
        predefinedMappingRadioButton.setName("predefinedMappingRadioButton"); // NOI18N
        predefinedMappingRadioButton.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                predefinedMappingRadioButtonChangeAction(evt);
            }
        });

        buttonGroup1.add(customMappingRadioButton);
        customMappingRadioButton.setText(resourceMap.getString("customMappingRadioButton.text")); // NOI18N
        customMappingRadioButton.setName("customMappingRadioButton"); // NOI18N

        predefinedMappingComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        predefinedMappingComboBox.setName("predefinedMappingComboBox"); // NOI18N
        predefinedMappingComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PredefinedMappingComboBoxChanged(evt);
            }
        });
        ...
        mappingPanelLayout.setVerticalGroup(
            ...
            .addGroup(mappingPanelLayout.createSequentialGroup()
                .addGroup(mappingPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(predefinedMappingRadioButton)
                    .addComponent(predefinedMappingComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(customMappingRadioButton)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        mappingTabbedPane.addTab(resourceMap.getString("customMappingPanelContainer.TabConstraints.tabTitle"), mappingPanel); // NOI18N
...
private void visicutModel1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_visicutModel1PropertyChange
  ...
  else if (evt.getPropertyName().equals(VisicutModel.PROP_SELECTEDPART))
  {
    ...
    if (p != null) {
      for (MappingSet m: MappingManager.getInstance().getAll()) {
        if (m.equalsInContent(p.getMapping())) {
          predefined=true;
          this.predefinedMappingComboBox.setSelectedItem(m.getName());
          break;
        }
      }
      if ((p.getMapping() == null) || p.getMapping().isEmpty()) {
        // no mapping is selected - by default show the predefinedMapping entry
        this.predefinedMappingComboBox.setSelectedIndex(0);
        predefined=true;
      }
      this.predefinedMappingRadioButton.setSelected(predefined);
      this.customMappingRadioButton.setSelected(!predefined);
      this.predefinedMappingRadioButtonChange();
    }
  }
...
private void saveMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveMenuItemActionPerformed
  ...
  try
  {
    this.visicutModel1.saveToFile(this.profileManager1, this.mappingManager1, this.visicutModel1.getPlfFile().getFile());
  }
  catch (Exception ex)
  {
    dialog.showErrorMessage(ex, bundle.getString("ERROR SAVING FILE"));
...
private void predefinedMappingRadioButtonChangeAction(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_predefinedMappingRadioButtonChangeAction
  predefinedMappingRadioButtonChange();
}//GEN-LAST:event_predefinedMappingRadioButtonChangeAction

/**
 * update the state of the other components to match predefinedMappingRadioButton.isSelected()
 */
private void predefinedMappingRadioButtonChange() {
  boolean selected = predefinedMappingRadioButton.isSelected();
  customMappingPanel2.setVisible(!selected); // TODO setEnabled() would be nicer, but this currently doesn't work
  predefinedMappingComboBox.setEnabled(selected);
}
 ...
 */
  ...
  private void saveLaserProperties(Map<LaserProfile, List<LaserProperty>> laserProperties) throws FileNotFoundException, IOException {
    ...
    private javax.swing.JRadioButton customMappingRadioButton;
    ...
    private javax.swing.JRadioButton predefinedMappingRadioButton;
