...
public class EditLaserDeviceDialog extends javax.swing.JDialog
{
  ...
  public void setCurrentLaserDevice(LaserDevice currentLaserDevice)
  {
    ...
    this.thumbnailButton.setText("<html><table cellpadding=3><tr><td><img width=64 height=64 src=file://" + currentLaserDevice.getThumbnailPath() + "/></td></tr></table></html>");
  }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTextField1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 267, Short.MAX_VALUE)
  ...
  {//GEN-HEADEREND:event_thumbnailButtonActionPerformed
    ...
    JFileChooser fc = new JFileChooser();     fc.setAcceptAllFileFilterUsed(false);     fc.addChoosableFileFilter(new ExtensionFilter(".png", "PNG Files (*.png)"));     if (this.currentLaserDevice.getThumbnailPath() != null)     {       fc.setSelectedFile(new File(this.currentLaserDevice.getThumbnailPath()));       fc.setCurrentDirectory(new File(this.currentLaserDevice.getThumbnailPath()).getParentFile());     }     fc.setDialogType(JFileChooser.OPEN_DIALOG);     if (fc.showOpenDialog(this) == JFileChooser.APPROVE_OPTION)     {       File thumb = fc.getSelectedFile();       this.currentLaserDevice.setThumbnailPath(thumb.getAbsolutePath());       this.thumbnailButton.setText("<html><table cellpadding=3><tr><td><img width=64 height=64 src=file://" + thumb.getAbsolutePath() + "/></td></tr></table></html>");     }   }//GEN-LAST:event_thumbnailButtonActionPerformed
